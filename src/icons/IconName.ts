...
export const IconInverseMap = {
  ...
  BurgerIcon: true,
  Calendar2Icon: true,
  CalendarCircleIcon: true,
  CalendarIcon: true,
  CalendarTickIcon: true,
  Car2Icon: true,
  CardIcon: true,
  CardPosIcon: true,
  CardTickIcon: true,
  CardWithGemIcon: false,
  CarIcon: false,
  ChartSquareIcon: true,
  CinemaIcon: false,
  ClockIcon: false,
  CloseIcon: true,
  ComfortableCompIcon: false,
  CreditCardsIcon: false,
  DiscountShapeIcon: true,
  DocDownloadIcon: true,
  DocIcon: true,
  DocIconMonoColor: true,
  DocsIcon: false,
  ...
  DoneSimpleIcon: true,
  EarthIcon: false,
  EmptyWalletChangeIcon: true,
  EmptyWalletIcon: true,
  EuroIcon: false,
  GeolocationIcon: true,
  GlassIcon: false,
  GlobalIcon: true,
  GpsIcon: true,
  GridIcon: true,
  InterestGrowthIcon: false,
  InterestIcon: true,
  JCBIcon: false,
  LogoIcon: true,
  LoupeIcon: true,
  MapMarkerClusterIcon: false,
  MapMarkerSingleIcon: false,
  MasterCardIcon: false,
  MinusIcon: true,
  MirIcon: false,
  MoneyIcon: true,
  MoneyInsuranceIcon: false,
  MoneysIcon: true,
  MonitorMobileIcon: true,
  NewDocIcon: false,
  OfficeIcon: false,
  OkIcon: true,
  PackA4Icon: false,
  PassSendIcon: false,
  PercentageRoundIcon: true,
  PercentageSquareIcon: true,
  PersonalCardIcon: true,
  PlayMarketIcon: true,
  PlusIcon: true,
  PowerIcon: false,
  Profile2UserIcon: true,
  ProfileIcon: true,
  PumpkinIcon: false,
  RoundRubleIcon: true,
  SafeIcon: true,
  ...
  WalletAddIcon: true,
  WalletIcon: true,
  WalletWithMoneyIcon: true,
  WateringCanIcon: false,
};
...
export enum IconMap {
  ...
  MirIcon = 'MirIcon',
  MoneyIcon = 'MoneyIcon',
  MoneyInsuranceIcon = 'MoneyInsuranceIcon',
  MoneysIcon = 'MoneysIcon',
...
export enum IconTitleMap {
  ...
  DollarIcon = 'Доллар',
  DoneIcon = "Зелёная 'галочка' в круге",
  DoneSimpleIcon = "Зелёная 'галочка'",
  EarthIcon = 'Земля',
  ...
  SoundIcon = 'Звук',
  StrongBoxIcon = 'Ящик с замочной скважиной',
  TelegramIcon = 'Лого «Telegram»',
  UnionPayIcon = 'UnionPay',
  UserSquareIcon = 'Пользователь в рамке',
