...
export enum IconTitleMap {
  ...
  LogoIcon = 'Logo',
  LoupeIcon = 'Лупа',
  MapMarkerClusterIcon = 'MapMarkerCluster',
  MapMarkerSingleIcon = 'MapMarkerSingle',
