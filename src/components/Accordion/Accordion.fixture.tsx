...
const HEADLINE_ACCORDION_BLOCK = <Headline className="col-span-12" {...HEADLINE} />;

const PICTURE_TEXT_ACCORDION_BLOCK = <PictureText className="col-span-12" {...PICTURE_TEXT} />;

const LINK_DOCS_ACCORDION_BLOCK = (
  <LinkDocs className="col-span-12" {...linkDocsContentExample} title="" />
);

const TILES_ACCORDION_BLOCK = <Tile className="col-span-6" {...TILE} />;

const PRODUCT_TILES_ACCORDION_BLOCK = <ProductTile className="col-span-6" {...PRODUCT_TILE} />;
...
export default {
  default: (
    <div className="container grid grid-cols-12">
      ...
      >
        {ACCORDION_ITEM}
        <AccordionItem label="Accordion label 2">{[PICTURE_TEXT_ACCORDION_BLOCK]}</AccordionItem>
        <AccordionItem label="Accordion label 3">{[HEADLINE_ACCORDION_BLOCK]}</AccordionItem>
        <AccordionItem label="Accordion label 4">{[LINK_DOCS_ACCORDION_BLOCK]}</AccordionItem>
        <AccordionItem label="Accordion label 5">
          {[TILES_ACCORDION_BLOCK, TILES_ACCORDION_BLOCK]}
        </AccordionItem>
        <AccordionItem label="Accordion label 6">
          {[PRODUCT_TILES_ACCORDION_BLOCK, PRODUCT_TILES_ACCORDION_BLOCK]}
        </AccordionItem>
        <AccordionItem label="Accordion label 7">{[GALLERY_ACCORDION_BLOCK]}</AccordionItem>
        <AccordionItem label="Accordion label 8">{[MINI_GALLERY_ACCORDION_BLOCK]}</AccordionItem>
      </Accordion>
    </div>
  ),
  'right-align-title': (
