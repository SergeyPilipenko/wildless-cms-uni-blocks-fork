...
export const CreditCalculatorForm = JSX<CreditCalculatorFormProps>(({ context, directoryName }) => {
  ...
  return (
    <section className="mt-7">
      <div className={`box-border p-[49px] pr-[56px] mx-auto w-max ${BORDER_STYLE}`}>
